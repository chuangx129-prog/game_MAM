...
> **📢 本仓库已转为原型/演示版。** 正式版《CreazyMum疯狂妈妈》(抖音小游戏,Cocos Creator 重制,
> 多关卡系列:深夜求生/上学/吃早饭/写作业…)在私有仓库开发中。本 H5 版继续作为可玩 demo 保留。
...
> 两个线上版本都连着本仓库,`git push` 后自动重新部署(EdgeOne 项目走 GitHub 导入;GitHub Pages 原生支持),
> 无需任何手动操作。`tools/pack-zip.ps1` 仅作备用(生成可手动上传的 zip 部署包)。
...
Phaser 已本地化(js/phaser.min.js),离线可玩。**最简单:双击桌面的「妈妈的无影脚」快捷方式**——
